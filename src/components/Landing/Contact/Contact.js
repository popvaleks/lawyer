  ...
  return (
    <div id="contact" className="contact__wrapper">
      ...
      <div className="contact__right-container">
        ...
        <iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3A3cce520844b2f4ada4184888328afed8aa5c51e41a2421e6287f8ab3389073e0&amp;source=constructor" width="854" height="856" frameBorder='0'></iframe>      </div>
    </div>
  )
}
